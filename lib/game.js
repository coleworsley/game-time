...
function onLoad (gameState, ballSpeedX, ballSpeedY) {
  let {paused, score, level, lives, brickRows, brickCols, brickStrength, 
    paddleWidth} = gameState;
...
function collidedWith (obj) {
  if (obj instanceof Brick) {
    ...
    console.log(sumBrickStrength, obj.strength);
