class Level {
  constructor () {
    this.presets = [
      {rows: 3, cols: 6, strength: 1, paddleWidth: 120,
        ballXV: 5, ballYV: -5, maxSpeed: 10},
      {rows: 4, cols: 6, strength: 2, paddleWidth: 100,
        ballXV: 5, ballYV: -5, maxSpeed: 10},
      {rows: 5, cols: 8, strength: 2, paddleWidth: 80,
        ballXV: 5, ballYV: -7, maxSpeed: 10},
      {rows: 5, cols: 8, strength: 3, paddleWidth: 80,
        ballXV: 5, ballYV: -9, maxSpeed: 10},
      {rows: 6, cols: 8, strength: 3, paddleWidth: 60,
